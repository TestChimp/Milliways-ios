...
Use the skill-wide rule (explicit scope → feature-branch changes → default branch since last
`upkeep` / ask user). See skill references/policies-and-traceability.md.
